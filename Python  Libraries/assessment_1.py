...
# Filter rows where acquiring institution is 'State Bank of Texas'
acquired_by_texas = banks[banks['Acquiring Institution'] == 'State Bank of Texas']

# Total number of banks acquired
total_acquired = acquired_by_texas.shape[0]

# Number of banks in Texas
acquired_in_texas = acquired_by_texas[acquired_by_texas['ST'] == 'TX'].shape[0]

total_acquired, acquired_in_texas

"""9) What is the most common city in California for a bank to fail in?"""

# Filter for banks in California (CA)
ca_banks = banks[banks['ST'] == 'CA']

# Most common city for failed banks in CA
